                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a v-on:click="addShow" class="btn btn-sm btn-default">Add Ramal</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card" style="width: 90%">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-5 pr-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="exten.context_to">
                                            <option  v-for="route in routes"  :selected="route.name == exten.context_to"  v-bind:value="route.name">
                                                {{ route.name }}
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 px-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" v-model="exten.dtlsverify" placeholder="">
                                    </div>
                                </div>
                                <div class="col-md-4 pl-1">
                                    <div class="form-group">
                                        <label>DTLSSETUP</label>
                                        <input type="text" v-model="exten.dtlssetup" class="form-control" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <button v-on:click="save()" class="btn btn-success pull-right">Salvar</button>
