                        ...
                        {{ Form::open(array('route' => ['queue.update', $queue['id']], 'method' => 'put')) }}
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('timeout') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" min="0" max="10" name="timeout" id="timeout" class="form-control{{ $errors->has('timeout') ? ' is-invalid' : '' }}" placeholder="{{ __('Tempo ring Agente [0 - 10]') }}" value="{{$queue['timeout']}}" required autofocus>
                                </div>
